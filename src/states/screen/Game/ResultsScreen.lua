...
function ResultsScreen:draw()
    ...
    love.graphics.printf("Max Combo", 300, 525, 150, "center")
    love.graphics.printf("Accuracy", 700, 525, 150, "center")
    love.graphics.printf("Rating", 1100, 525, 150, "center")
    love.graphics.printf("Score", 1500, 525, 150, "center")
