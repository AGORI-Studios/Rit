...
function GI.LoadDefaultFonts()
    ...
    Cache.members.font["menu"] = love.graphics.newFont("assets/fonts/Montserrat-Light.ttf", 32)
    Cache.members.font["menuBold"] = love.graphics.newFont("assets/fonts/Montserrat-Medium.ttf", 22)
