...
function Gameplay:new()
    ...
    Parsers["Quaver"]:parse("Assets/IncludedSongs/lapix feat. mami - Irradiate (Nightcore Ver.) - 841472/147043.qua", "Assets/IncludedSongs/lapix feat. mami - Irradiate (Nightcore Ver.) - 841472/")
