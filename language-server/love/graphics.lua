...
---@overload fun(text: any, transform: love.Transform)
---@overload fun(coloredtext: table, transform: love.Transform)
---@overload fun(text: any, font: love.Font, transform: love.Transform)
...
---
---@overload fun(text: any, font: love.Font, x: number, y: number, limit: number, align?: love.AlignMode, r?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
---@overload fun(text: any, transform: love.Transform, limit: number, align?: love.AlignMode)
---@overload fun(text: any, font: love.Font, transform: love.Transform, limit: number, align?: love.AlignMode)
